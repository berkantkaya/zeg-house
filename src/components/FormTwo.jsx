...
const FormTwo = () => {
  ...
  return (
    <div className="relative flex items-center justify-around flex-wrap md:flex-nowrap">
      <div className="w-full md:w-1/2 md:flex md:justify-center">
        <div className="md:flex md:flex-col px-6 py-5 md:px-3 md:py-0 space-y-4">
          ...
          Uğur Mumcu Mahallesi  8790/5 Sokak No:157/A Çiğli İzmir
          </p>
      ...
      <div className=" w-full md:w-1/2 ">
        <div className="block p-6 bg-white max-w-2xl">
